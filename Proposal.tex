...
\begin{abstract}
We have be created a side-scrolling game where the player dodges obstacles to gather points for highscores, which we are calling "Leaping Llamas." we have added difficulty elements to increase the difficulty as preferred. Players looking for a casual yet challenging game should enjoy Leaping Llamas.
\end{abstract}
}
\maketitle
